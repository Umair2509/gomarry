...
import { View, Text,RefreshControl,TouchableOpacity,ActivityIndicator,FlatList } from "react-native";
import Api from "../../service/Api";
import UserCard from "../components/UserCard";
function NewestMembersScreen({navigation}) {
  useEffect(() => {
    Api.search({ sort: "online" }, 1, 6)
      .then((data) => {
        // console.log(data, "Api Data in newest member screen");       
