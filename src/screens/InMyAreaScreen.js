...
function InMyAreaScreen({navigation}) {
  useEffect(() => {
    Api.search({ sort: "distance" }, 1, 6)
      .then((data) => {
        // console.log(data, "Api Data in my area screen");       
