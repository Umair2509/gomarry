...
function MostCompatibleScreen({navigation}) {
  useEffect(() => {
    Api.search({ sort: "compatibility" }, 1, 6)
      .then((data) => {
        // console.log(data, "Api Data in most compatible screen");       
  ...
  const load_more=()=>{
    ...
    Api.search({ sort: "compatibility" }, i, 6)
      .then((data) => {
...
export default MostCompatibleScreen;